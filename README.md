...
- GAN은 데이터 분포를 학습하여 새로운 샘플을 생성하는 데 강력한 성능을 보여줍니다.
- 조명 배치와 같은 미지의 문제에서 실제와 유사한 결과물을 생성할 수 있습니다.
- 배치 위치 추천이라는 문제를 해결하기 위해 생성적 모델을 선택한 이유:
  - 기존 데이터에서 학습된 특징을 기반으로 새로운 조명 배치 제안을 생성.
  - 조명 배치의 창의적이고 직관적인 해결 방안을 제시.
